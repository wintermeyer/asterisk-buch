...
** xref:einfache-ivr.adoc#ivr-unterschied-playback-und-background[Unterschied zwischen Playback() und Background()]
** xref:einfache-ivr.adoc#ivr-unterschied-10-und-1000[Unterschied zwischen 10 und 1000]
** xref:einfache-ivr.adoc#ivr-falscheingaben[Falscheingaben (die i-Extension)]
** xref:einfache-ivr.adoc#ivr-pausen[Pausen]
* xref:mehrstufige-ivr.adoc[Mehrstufige IVR-Systeme]
** xref:mehrstufige-ivr.adoc#ivr-tiefe[Tiefe der IVR]
* xref:text2speech.adoc[Text-to-Speech (TTS)]
** xref:text2speech.adoc#installation-cepstral-tts[Installation von Cepstral Text-to-Speech]
** xref:text2speech.adoc#cepstral-beispiel[Beispiele und Tests]
** xref:text2speech.adoc#cepstral-pausen[Pausen in Texten]
