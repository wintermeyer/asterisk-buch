[[iax-vs-sip-historisch]]
= IAX vs. SIP
:description: Die historische Mark-Spencer-E-Mail zum Vergleich IAX vs. SIP aus den frühen Asterisk-Jahren.
...
interpretation.footnote:[Anm.: Ironischerweise gab es (kleinere) Inkompatibilitäten zwischen den IAX-Implementierungen in den Asterisk-Versionen 1.2, 1.4 und 1.6.]
...
RF3261footnote:[Anm.: sic. Gemeint ist RFC 3261 (https://datatracker.ietf.org/doc/html/rfc3261).].
...
this time.footnote:[Anm.: Seit Februar 2009 ist IAX2 als RFC 5456 (https://datatracker.ietf.org/doc/html/rfc5456) standardisiert.]
