...
* Dem Transport sagen Sie, welche öffentliche Adresse er "außen" hat:
  `external_media_address` für RTP/Medien und `external_signaling_address`
  für die SIP-Signalisierung. Beide akzeptieren wahlweise eine
  IP-Adresse oder einen DNS-Namen:
+
[source]
----
[transport-udp]
