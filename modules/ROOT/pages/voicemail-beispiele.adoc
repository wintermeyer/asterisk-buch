...
typische Konstellationen. Anschließend (in xref:voicemail-applikationen.adoc[Abschnitt 13.3, „Applikationen“]) gehen wir auf die Besonderheiten und
Möglichkeiten von Voicemail-Systemen unter Asterisk ein.
...
klassischen (deprecated) `Macro()`-Applikation:
...
Die in xref:case-study.adoc[Kapitel 5, _Case-Study einer Beispielfirma_] vorgestellte Apfelmus GmbH
