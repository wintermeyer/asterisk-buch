...
Sagt die übergebene Zeit. _`Timestamp`_ ist dabei
die Anzahl der Sekunden seit 00:00:00 Uhr am 1. Januar 1970. Die Ausgabe
kann durch die Eingabe einer Ziffer abgebrochen werden, die in
