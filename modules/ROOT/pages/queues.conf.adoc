...
In Asterisk 1.6 wird voraussichtlich das
`roundrobin`-Verfahren wegfallen und `rrmemory`
in `roundrobin` umbenannt werden.
...
Weitere Informationen über Mitschnitte siehe xref:applications-monitor.adoc[Abschnitt C.100, „`Monitor()`“]
...
Zu
weiteren Informationen über Mitschnitte siehe: xref:applications-monitor.adoc[Abschnitt C.100, „`Monitor()`“]
