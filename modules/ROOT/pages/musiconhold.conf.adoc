...
Bitte beachten Sie, dass für das Abspielen von Musik
gegebenenfalls Gebühren an die http://www.gema.de/[_GEMA_] zu
entrichten sind. Freie klassische Werke finden Sie unter anderem auf
http://www.classiccat.net/ zum
Download. Oder Sie verwenden die drei mitgelieferten Stücke.
