[[installation-1.6-debian]]
= Installation von Asterisk 1.6.x auf Debian Linux
...
[NOTE]
====
Ja, libpri 1.4.x ist die richtige Version für Asterisk 1.6.
====
...
[NOTE]
====
Bei Asterisk 1.6 ist die Nummerierung der Versionen etwas anders als
bei 1.4. Die Versionen 1.6.0.x, 1.6.1.x, 1.6.2.x usw. sind
unterschiedliche Zweige („Branches“), d.h., es gibt eine URL
`1.6.0-current`, und es wird auch demnächst eine URL
`1.6.1-current` geben.
====
...
[...]
Die folgenden NEUEN Pakete werden zusätzlich installiert:
  libjpeg62-dev{a} libspandsp-dev libspandsp1{a} 
  libtiff4{a} libtiff4-dev{a} libtiffxx0c2{a} 
0 Pakete aktualisiert, 6 zusätzlich installiert, 0 werden entfernt und 0 nicht aktualisiert.
Muss 1328kB an Archiven herunterladen. Nach dem Entpacken werden 3801kB zusätzlich belegt sein.
[...]
----
...
[...]
Die folgenden NEUEN Pakete werden zusätzlich installiert:
  libasound2{a} libasound2-dev{a} libavc1394-0{a} 
  libfreebob0{a} libiec61883-0{a} libjack-dev 
  libjack0{a} libjack0.100.0-dev{a} libportaudio2{a} 
  libraw1394-8{a} libxml2{a} portaudio19-dev 
  sgml-base{a} xml-core{a} 
0 Pakete aktualisiert, 14 zusätzlich installiert, 0 werden entfernt und 0 nicht aktualisiert.
Muss 2420kB an Archiven herunterladen. Nach dem Entpacken werden 7930kB zusätzlich belegt sein.
[...]
----
...
[source,shell]
----
debian:/usr/src/asterisk-1.6.0.6# make samples
[...]
debian:/usr/src/asterisk-1.6.0.6# 
----
